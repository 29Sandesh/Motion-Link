...
export const DIRECTION_VECTORS: Record<CutDirection, Vector3> = {
  [CutDirection.UP]: new Vector3(0, 1, 0),
  [CutDirection.DOWN]: new Vector3(0, -1, 0),
  [CutDirection.LEFT]: new Vector3(-1, 0, 0),
  [CutDirection.RIGHT]: new Vector3(1, 0, 0),
  [CutDirection.ANY]: new Vector3(0, 0, 0) // Magnitude check only
};